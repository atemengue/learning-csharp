...
menuBuilder.AppendLine("Welcome to the burger Mojito FC");
menuBuilder.AppendLine(string.Empty);
menuBuilder.AppendLine("1 ) Burgers and Fries - 5 USD");
menuBuilder.AppendLine("2 ) Cheeseburgers - 7 USD");
menuBuilder.AppendLine("3 ) Double-cheeseburgers - 9 USD");
...
switch (option.KeyChar.ToString())
{
  ...
  case "4":
    {
      Console.WriteLine("\nThank you for ordering Coke. Please pay the cashier."); break;
    }
