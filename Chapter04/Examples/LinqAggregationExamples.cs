...
namespace Chapter04.Examples
{
  ...
  public class LinqAggregationExamples
  {
    ...
    public static void RunLinqAggregationExamples()
    {
      var processes = Process.GetProcesses().ToList();
      var allProcesses = processes.Count;
      var smallProcesses = processes.Count(proc => proc.PrivateMemorySize64 < 5000);
      ...
      Console.WriteLine($"    Minimun: {FormatBytes(min)}");
